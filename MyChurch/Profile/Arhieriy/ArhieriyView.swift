...
class ArhieriyView: UIView {
    ...
    override func layoutSubviews() {
        ...
        statusTextLabel.pin.below(of: serNameGrayLine).horizontally(15).height(20).marginTop(30)
        ...
        birthdayLabel.pin.below(of: statusBackView).horizontally(15).height(20).marginTop(30)
        ...
        hramLabel.pin.below(of: emailGrayLine).horizontally(15).height(20).marginTop(30)
